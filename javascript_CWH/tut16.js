console.log(`L-16 Create, remove and replace elements`);
...
// quick quiz
// create a heading element with text as "Go to CodeWithHarry" and create an a tag

let hh1 = document.createElement("h1");
// hh1.innerHTML = "Go to Code with Harry";
let a1 = document.createElement("a");
a1.setAttribute("href", "https://www.codewithharry.com");
a1.setAttribute("target", "blank");
a1.innerHTML = "Go to Code with Harry";

hh1.appendChild(a1);
let selectedUL = document.getElementById("myul");
selectedUL.appendChild(hh1);
